      ...
      <div className='mx-auto container p-4'>
        <div className='bg-white p-5 w-full max-w-sm mx-auto'>
          ...
          <form className='pt-6 flex flex-col gap-2' onSubmit={handleSubmit}>
            ...
            <div className='grid'>
              <label>Role :</label>
              <select name='role' value={data.role} onChange={handleOnChange} required>
            ...
            <div className='grid'>
              <label>Password :</label>
              <input type={showPassword ? "text" : "password"} name='password' value={data.password} onChange={handleOnChange} required />
            ...
            <div className='grid'>
              <label>Confirm Password :</label>
              <input type={showConfirmPassword ? "text" : "password"} name='confirmPassword' value={data.confirmPassword} onChange={handleOnChange} required />
